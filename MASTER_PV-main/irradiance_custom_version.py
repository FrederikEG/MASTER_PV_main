# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 10:18:31 2024
...
def get_sky_diffuse_custom(surface_tilt, surface_azimuth,
                    solar_zenith, solar_azimuth,
                    dni, ghi, dhi, dni_extra=None, airmass=None,
                    model='isotropic',
                    model_perez='allsitescomposite1990'):
    ...
    if model == 'isotropic':
        ...
        sky = haydavies(surface_tilt, surface_azimuth, dhi, dni, dni_extra,
                        solar_zenith, solar_azimuth, return_components=True)
    elif model == 'reindl':
        ...
        sky = perez(surface_tilt, surface_azimuth, dhi, dni, dni_extra,
                    ...
                    model=model_perez, return_components= True)
